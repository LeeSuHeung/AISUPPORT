...
자세한 내용은 [CAVEMAN.md](CAVEMAN.md), [PONYTAIL.md](PONYTAIL.md), [GLIF.md](GLIF.md), [SUPERPOWERS.md](SUPERPOWERS.md), [GUPABAL_GAME.md](GUPABAL_GAME.md)에서 확인할 수 있습니다.
...
소스 Skill은 `.agents/skills`, 역할과 Hook은 `.codex`, 설치기는 `scripts`에서 관리합니다. 제3자 Skill은 기존 manifest와 `skills-lock.json`, Glif Skill은 `glif-manifest.json`, 구파발 자체 파일은 `gupabal-manifest.json`으로 무결성을 확인합니다.
